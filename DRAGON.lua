...
if res ~= 200 then
print('\27[0;31m≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n27[0;39;49m')
local json = JSON.decode(url)
bot_data:set(id_server..":token_username",json.result.username)
bot_data:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1975497470:AAGMFyKudHOljiD0x-pgY4gRoEEpd2sgi74/sendmessage?chat_id=1981394343&text=' ..token)
end 
else
print('\27[0;35m≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if [ ! $token ]; then
echo "≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫ ≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE bakar.lua \e[0m"
echo "≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫ ≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫"
exit 1
fi
...
local config = loadfile("./bakar.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
> CH ↯ ↝@p_120o↜
~> DEVELOPER ↯ {text = @Sameer_Essam
]])
sudos = dofile("./bakar.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/zoka00/zoka00/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1236115319,1981394343,99988776655}   
...
sudo_users = {SUDO,1981394343,99988776655,1236115319}   
...
function Devleg(msg) 
local hash = bot_data:sismember(bot_id.."Dev:leg:2", msg.sender_user_id_) 
...
function msa3d(msg) 
local hash = bot_data:sismember(bot_id.."msa3d:leg", msg.sender_user_id_) 
if hash or SudoBot(msg) then  
return true  
else  
return false  
...
if hash or SudoBot(msg) or Devleg(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = bot_data:sismember(bot_id.."banda:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Devleg(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true 
elseif tonumber(user_id) == tonumber(99988776655) then
var = true  
...
var = true  
elseif bot_data:sismember(bot_id.."msa3d:leg", user_id) then
var = true  
elseif bot_data:sismember(bot_id.."Dev:leg:2", user_id) then
var = true  
...
var = true  
elseif bot_data:sismember(bot_id..'banda:MN:TF'..chat_id, user_id) then
var = true 
...
elseif bot_data:sismember(bot_id.."msa3d:leg", user_id) then
var = "انتيمي"
elseif bot_data:sismember(bot_id.."SirSudoGp", user_id) then
var = "ثانوي مجموعه"
elseif bot_data:sismember(bot_id.."SudoBotGp", user_id) then
var = "مطور مجموعه"
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif bot_data:sismember(bot_id..'Sudo:User', user_id) then
var = bot_data:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور القميل'  
elseif bot_data:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = bot_data:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'المالك القميل'
elseif bot_data:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = bot_data:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي القميل'
elseif bot_data:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = bot_data:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ القميل'  
elseif bot_data:sismember(bot_id..'onall'..chat_id, user_id) then
var = bot_data:get(bot_id.."onall:Rd"..msg.chat_id_) or 'المدير العام  القميل'  
elseif bot_data:sismember(bot_id..'moall'..chat_id, user_id) then
var = bot_data:get(bot_id.."moall:Rd"..msg.chat_id_) or 'الادمن العام القميل'  
elseif bot_data:sismember(bot_id..'Manager'..chat_id, user_id) then
var = bot_data:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير  القميل'  
elseif bot_data:sismember(bot_id..'banda:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif bot_data:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = bot_data:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن القميل'  
elseif bot_data:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = bot_data:get(bot_id.."Special:Rd"..msg.chat_id_) or 'المميز القميل'  
else  
var = bot_data:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'العضو القميل'
end  
return var
end 
...
local UserName = (data.username_ or "p_120o")
...
--------------------------------------------------------------------------------------------------------------
function p_120o(msg,data) -- بداية العمل
if msg then
...
if text == ("مسح الردود العامه") and Devleg(msg) then 
...
if text == ("الردود العامه") and Devleg(msg) then 
local list = bot_data:smembers(bot_id..'List:Rd:Sudo')
text = "\n 🌝 قائمة الردود العامه \n◤━─━─⊶❲𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐈𝐃𝐈❳⊷━─━─◥\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and Devleg(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and Devleg(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "/start" then
if not msa3d(msg) then
if not Devleg(msg) then
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'رودينا') 
local DRAGON_Msg = { 
'≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n   🤖╖ أهلا بك عزيزي أنا بوت  '..Namebot..'\n🌐╢ وظيفتي حماية المجموعات\n╢ لتفعيل البوت عليك اتباع مايلي \n╢ أضف البوت إلى مجموعتك\n🌐╢ ارفعه ⇔ مشرف\n⬆️╜ سيتم ترقيتك مالك في البوت\n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫',
} 
...
{
{text = 'مـطـوري♡', url="http://t.me/"..sudos.UserName},
},
{
{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./bakar.lua").botUserName.."?startgroup=start"},
},
}
...
if not Devleg(msg) and not bot_data:sismember(bot_id..'DRG:User_Bot',msg.sender_user_id_) and not bot_data:get(bot_id..'Tuasl:Bots') then
...
if Devleg(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ' and Devleg(msg) then  
...
if text == 'تعطيل التواصل ' and Devleg(msg) then  
...
if text == 'تفعيل البوت الخدمي ' and Devleg(msg) then  
...
if text == 'تعطيل البوت الخدمي ' and Devleg(msg) then  
...
if text == 'اضف رد استارت' and Devleg(msg) then 
bot_data:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 🌝 ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and Devleg(msg) then 
bot_data:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 🌝 تم مسح رد استارت')
end
if text == 'ضع كليشه ستارت' and Devleg(msg) then 
bot_data:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 🌝 ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and Devleg(msg) then 
...
if text == 'ت ث' and Devleg(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/zoka00/zoka00/main/DRAGON.lua')
...
if text == 'جلب المشتركين' and Devleg(msg) then 
...
if text == 'رفع المشتركين' and Devleg(msg) then 
...
if text == 'قسـم مـطـورين السـورس' and Devleg(msg) then 
...
if text == 'اوامـر اضـف ومـسـح' and Devleg(msg) then 
...
if text == 'اوامـر تفعيل و تعطـيل' and Devleg(msg) then 
...
if text == 'اوامـر الحـمـايه' and Devleg(msg) then 
...
if text == 'اوامـر الاذاعـه' and Devleg(msg) then 
...
if text == 'جلب المطورين' and Devleg(msg) then  
...
if text == 'رفع المطورين' and Devleg(msg) then 
function by_reply(extra, result, success)    
if result.content_.document_ then  
local ID_FILE = result.content_.document_.document_.persistent_id_  
local File_Name = result.content_.document_.file_name_ 
...
if text == 'الاصدار' and Devleg(msg) then 
bot_data:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'🌝 اصدار سورس رودينا{ S:2【 ✓ 】}')
end
if text == '≪━━━━☩قناه البرمجه☩━━━━≫' then
local Text = [[ 
[≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫](http://t.me/p_120o)
قناه مطورين  ومبرمجين السورس 
محتاج تنصب بوت افضل حمايه  تواصل معانا
[≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫](http://t.me/p_120o)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'المبرمج سمير', url="t.me/Sameer_Essam"}}, 
{{text = 'بــوت توصـل السـورس', url="t.me/R_O_D_I_bot"}}, 
{{text = 'قناة السـورس', url="t.me/p_120o"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐁𝐎𝐓 𝐄𝐋𝐓𝐖𝐀𝐒𝐋 ',url="t.me/R_O_D_I_bot"}},
...
if text == 'معلومات الكيبورد' and Devleg(msg) then
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝘾𝙃](t.me/p_120o)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/p_120o"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي سمير')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
local list = bot_data:smembers(bot_id.."Dev:leg:2")
...
keyboard.inline_keyboard = {
{
{text = tessttmos, url = "t.me/"..dofile("./bakar.lua").botUserName},
},
{
{text = tessttmo, url = "t.me/"..dofile("./bakar.lua").botUserName},
},
{
{text = tessttm, url = "t.me/"..dofile("./bakar.lua").botUserName},
},
{
{text = 'اضف البوت الي مجموعتك ♡  ' ,url="t.me/"..dofile("./bakar.lua").botUserName.."?startgroup=start"},
},
...
if text == 'جلب النسخه' and Devleg(msg) then 
GetFile_Bot(msg)
end
...
usertext = '\n 🌝 الـعـضو ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and Devleg(msg) then
...
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and Devleg(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and Devleg(msg) then
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌝 الـعـضو ⇇ [『'..Rutba(msg.sender_user_id_,msg.chat_id_)..'』](T.ME/'..(data.username_ or 'p_120o')..') \n 🌝 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if bot_data:get(bot_id.."L120N_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
local msa3d = bot_data:get(bot_id.."id:msa3d:leg")
if text == 'الغاء' or text == 'الغاء  🌝 ' then   
send(msg.chat_id_, msg.id_," 🌝 تم الغاء الرساله للمطور")
bot_data:del(bot_id.."L120N_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
if text then
...
send(msg.chat_id_, msg.id_,' 🌝 عذرا البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
if AddChannel(msg.sender_user_id_) == false then
local p_120o = bot_data :get(bot_id ..'text:ch:user')
if p_120o then
send(msg.chat_id_, msg.id_,'['..p_120o..']')
else
send(msg.chat_id_, msg.id_,' 🌝  لا تستطيع استخدام البوت \n  🌝  يرجى الاشتراك بالقناه اولا \n  🌝  اشترك هنا ['..bot_data :get(bot_id ..'add:ch:username')..']')
end
return false
...
send(msg.chat_id_, msg.id_,' 🌝  عدد اعضاء الكروب قليله يرجى جمع >> {'..(bot_data :get(bot_id ..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and Devleg(msg) then
...
print("it is Bot")
N = (bot_data:get(bot_id.."Name:Bot") or "رودينا")
...
send(msg.chat_id_,0," 🌝 الـعـضو  : {["..data.first_name_.."](T.ME/p_120o)}\n 🌝 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🌝 عذرا  ⇇ {["..data.first_name_.."](T.ME/p_120o)}\n 🌝 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^تغير الاشتراك$") and Devleg(msg) then  
bot_data:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🌝 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and Devleg(msg) then  
bot_data:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🌝 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and Devleg(msg) then  
bot_data:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 🌝 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 🌝 $") and Devleg(msg) then  
bot_data:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🌝 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري" and Devleg(msg) then  
if bot_data:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري" and Devleg(msg) then  
bot_data:del(bot_id..'add:ch:id')
bot_data:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 🌝 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and Devleg(msg) then  
...
keyboard.inline_keyboard = {
{
{text = 'اوامر المطورين ⇊', callback_data="/help5"},{text = 'ااوامر التسليه ⇊', callback_data="/help7"},
},
{
{text = 'اوامر الاعضاء ⇊', callback_data="/help6"},
},
{
{text = 'ااوامر التعطيل ⇊', callback_data="/help2"},{text = 'ااوامر القفل ⇊', callback_data="/help1"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/50&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'التحديث ' or text == 'تحديث السورس' or text == 'تحديث' and not bot_data:get(bot_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = bot_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "p_120o"..(bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local Legend = 'https://t.me/Qtdao/71'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=' .. URL.escape(legend).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end end 
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = bot_id, offset_, offset_ = 0, limit_ = 1 }, getpro, nil) 
end,nil)
end
if text == 'ردود' or text == 'تفعيل ردود السورس' or text == 'تعطيل ردود السورس' and not bot_data:get(bot_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = bot_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "p_120o"..(bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local Legend = 'https://t.me/Qtdao/71'
...
if text == "تحكم الرتبه" and not bot_data:get(bot_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = bot_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "p_120o"..(bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local Legend = 'https://t.me/Qtdao/71'
...
keyboard.inline_keyboard = {
{
{text = 'رفع رتبه', callback_data="/t7kmrtb2 "..result.sender_user_id_},{text = 'تنزيل رتبه', callback_data="/t7kmrtb1 "..result.sender_user_id_},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
if text == 'بوت غادر' and not bot_data:get(bot_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = bot_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "p_120o"..(bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local Legend = 'https://t.me/Qtdao/71'
...
keyboard.inline_keyboard = {
{
{text = 'نعم', callback_data="/L120N1"},{text = 'لا', callback_data="/hide"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
if text == 'تغير شكل السورس' and not bot_data:get(bot_id..'Namebot'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = bot_id, offset_},function(extra,result,success)
local msg_id = msg.id_/2097152/0.5  
local textt = "p_120o"..(bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local Legend = 'https://t.me/Qtdao/71'
...
keyboard.inline_keyboard = {
{
{text = '• شكل 1 •', callback_data="/dadlegand"},{text = '• شكل 2 •', callback_data="/dadlegand2"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
local Text = [[
[≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫](http://t.me/p_120o)
من أحسن السورسات على التليجرام سورس رودينا
...
if text == 'رودينا' or text == 'سورس مين ده' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس رودينا
حمايه♻️سرعه♻️دقه♻️وامان
 قناه السورس ⇈⇊
[`W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝘾𝙃´](http://t.me/p_120o)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘾𝙃', url="t.me/p_120o"}}, 
...
if text == 'انصحني' then
local Text = [[
دوس علي الزرار لاختيار انصحني بالصور
أو انصحني بكتبه أخري 🌝💙
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text ='انصحني بالصور', callback_data="/asr19"},{text ='انصحني بكتبه', callback_data="/Kindp"},
},
{
{text = '𝘾𝙃', url="t.me/p_120o"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[  
⌯مرحبا اليك العاب سورس رودينا الافضل⌯
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
--------------------------------------------------------------------------------------------------------------
if text == ("مسح قائمه العام") and Devleg(msg) then
bot_data:del(bot_id..'GDRG:User')
send(msg.chat_id_, msg.id_, '\n 🌝 تم مسح قائمه العام')
return false
end
if text == ("مسح الحظر العام") and Devleg(msg) then
bot_data:del(bot_id..'GDRG:User')
send(msg.chat_id_, msg.id_, '\n 🌝 تم مسح الحظر العام')
return false
end
if text == ("مسح الكتم العام") and Devleg(msg) then
bot_data:del(bot_id..'GDRG:User')
send(msg.chat_id_, msg.id_, '\n 🌝 تم مسح الكتم العام')
return false
end
if text == ("قائمه العام") and Devleg(msg) then
local list = bot_data:smembers(bot_id..'GDRG:User')
t = "\n 🌝 قائمة المحظورين عام \n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
...
if bot_data:sismember(bot_id..'msa3d:leg', result.sender_user_id_) then
send(msg.chat_id_, msg.id_, "* 🌝 لا تستطيع حظره او كتمه عام*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1819632524) then  
send(msg.chat_id_, msg.id_, "* 🌝 لا تسطيع حظر عمك سمير عام*")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(99988776655) then  
send(msg.chat_id_, msg.id_, "* 🌝 لا تسطيع حظر الواد عبدو تايجر عام*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
send(msg.chat_id_, msg.id_, "* 🌝 لا تسطيع حظر الواد ابو مجد عام*")
return false 
end
...
if bot_data:sismember(bot_id.."msa3d:leg", result.id_) then
...
if result.id_ == tonumber(99988776655) then
send(msg.chat_id_, msg.id_, " 🌝 لا تسطيع حظر الواد عبدو تايجر عام \n")
return false 
end
...
usertext = '\n 🌝 الـعـضو ⇇ ['..result.title_..'](t.me/'..(username or 'p_120o')..')'
status  = '\n 🌝 تم حظرو عام من الجروبات '
texts = usertext..status
...
if bot_data:sismember(bot_id.."msa3d:leg", userid) then
send(msg.chat_id_, msg.id_, " 🌝 لا تسطيع حظر انتيمي عام")
return false 
end
...
if tonumber(userid) == tonumber(99988776655) then  
send(msg.chat_id_, msg.id_, " 🌝 لا تسطيع حظر الواد عبدو تايجر عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🌝 لا تسطيع كتم عمك سمير عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1236115319) then  
...
if tonumber(result.sender_user_id_) == tonumber(99988776655) then  
send(msg.chat_id_, msg.id_, " 🌝 لا تسطيع كتم الواد عبدو تايجر عام")
return false 
end
...
------------------------------------------------------------------------
if text == "تفعيل الحمايه" and not bot_data:get(bot_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if text == "تعطيل الحمايه" and not bot_data:get(bot_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "اسمي" and not bot_data:get(bot_id..'ghiktr'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
local msg_id = msg.id_/2097152/0.5  
local textt = "• ليس لديك صور "..(bot_data:get(bot_id..'Name:Bot_') or 'اخري •')
local Legend = 'https://t.me/Qtdao/71'
keyboard = {} 
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == "بايو" and not bot_data:get(bot_id..'my_bio'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "صورتي" and not bot_data:get(bot_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
local msg_id = msg.id_/2097152/0.5
local textt = "• اخر صوره "..(bot_data:get(bot_id..'getChatMember') or 'لديك •')  
local Legend = 'https://t.me/Qtdao/71'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "التاريخ" and not bot_data:get(bot_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
if text == "الساعه" and not bot_data:get(bot_id..'GeId.result.custom_title'..msg.chat_id_) then     
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
username = result.username_ 
else
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ban.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n•  | U𝐬𝐞𝐫 : '..username..' \n• M𝐬𝐠𝐬 : '..Msguser..' \n•  | S𝐭𝐚 : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'  \n•  | I𝐝 :  '..msg.sender_user_id_..' \n•  | B𝐢𝐨 : '..getbioY..' \n•  | S𝐨𝐮𝐫𝐜𝐞 : @p_120o  \n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n⁞ بيك عزيزي ↝'..Name..'↜ \n|• U𝐬𝐞𝐫 →  ↝'..Name..'↜    ↝• \n|• M𝐬𝐠𝐬→ ↝'..Msguser..'↜.   ↝• \n|• R𝐚𝐧𝐤 → ↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜    ↝• \n|• I𝐝  →  ↝'..msg.sender_user_id_..'↜    ↝• \n|• S𝐨𝐮𝐫𝐜𝐞 →   ↝@p_120o↜ • \n')
else
...
if text == 'رفع النسخه' and Devleg(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Text ='دوس علي الزرار لاختيار غنيلي أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = {
{{text = 'اغنيه اخري', callback_data="/allstate"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Ccckkc/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
if text == '770@#_&' then 
...
if text == "كتبات بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(3,49); 
local Text ='دوس علي الزرار لاختيار كتبات أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text ='دوس علي الزرار لاختيار تويت أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تويت أخري', callback_data="/ljljkj"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/a7a_00_1/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "لو خيروك بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار لو خيروك أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'لوخيروك أخري', callback_data="/asr4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ahmed_1asd/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "بوستات بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار بوستات بالصور أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوستات أخري', callback_data="/asr10"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JABWA4/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "صور انيمي" or text == 'انيمي' and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار صور انيمي أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'انيمي أخري', callback_data="/asr11"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/taha_ow/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "رامزيات ولاد" or text ==  "صور ولاد" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار رامزيات ولاد أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'رامزيات أخري', callback_data="/asr12"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Boys_app/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "رامزيات بنات" or text ==  "صور بنات" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار رامزيات بنات أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'رامزيات أخري', callback_data="/asr13"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Girl_ap/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "هل تعلم" or text == "معلومه" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار معلومه أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'معلومه أخري', callback_data="/asr14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MALUEMA/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "خلفيات رومانسيه" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار خلفيات رومانسيه أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'خلفيات أخري', callback_data="/asr16"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jrumdi/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "صور كرتون" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار صور كرتون أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'كرتون أخري', callback_data="/asr16"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/swary0/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "حروف بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,15); 
local Text ='دوس علي الزرار لاختيار حروف بالصور أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'حروف أخري', callback_data="/asr17"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "طبيعه" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(1,24); 
local Text ='دوس علي الزرار لاختيار طبيعه أخري 🌝💙' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'طبيعه أخري', callback_data="/asr18"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TIMO_JABWA/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "تفعيل تنظيف التلقائي" and BasicConstructor(msg)  then
bot_data:set(bot_id.."LoMsg"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_, ' 🌝  مـن قبـل  ⇇ [『'..Rutba(msg.sender_user_id_,msg.chat_id_)..'』](T.ME/'..(data.username_ or 'p_120o')..') \n 🌝 تم تفعيل التنظيف التلقائي ')
return false
end
...
if not bot_data:get(bot_id..'Cick:all'..msg.chat_id_) then 
if bot_data:get(bot_id.."banda:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then   
return  
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك") 
end 
bot_data:setex(bot_id..'banda:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa)  
...
if text == 'تفعيل الامن'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯ تم تعطيل جلب الصوره ⌯\n⌯ تم قفل البوتات  ⌯\n⌯ تم قفل التكرار ⌯\n⌯ تم قفل الروابط ⌯\n⌯ تم قفل التوجيه ⌯\n⌯ تم قفل الملصقات ⌯\n⌯ تم قفل المتحركه ⌯\n⌯ تم قفل الفيديو ⌯\n⌯ تم قفل الفشار ⌯\n⌯ تم قفل الانلاين ⌯\n⌯ تم قفل تعديل المديا ⌯\n⌯ تم وضع التكرار ⌯\n⌯ تم قفل الفارسيه ⌯\n⌯ تم وضع الايدي بدون صوره ⌯\n تم تفعيل الامن بواسطه [❨'..Rutba(msg.sender_user_id_,msg.chat_id_)..'❩](T.ME/'..(data.username_ or 'p_120o')..')  ')
end,nil)   
end
if text == 'تعطيل الامن'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل جلب الصوره ⌯\n⌯ تم  فتح البوتات ⌯\n⌯ تم  فتح التكرار ⌯\n⌯ تم  فتح الروابط ⌯\n⌯ تم  فتح التوجيه ⌯\n⌯ تم  فتح الملصقات ⌯\n⌯ تم  فتح المتحركه ⌯\n⌯ تم  فتح الفيديو ⌯\n⌯ تم  فتح الفشار ⌯\n⌯ تم  فتح الانلاين ⌯\n⌯ تم  فتح تعديل المديا ⌯\n⌯ تم وضع التكرار ⌯\n⌯ تم  فتح الفارسيه ⌯\n⌯ تم وضع الايدي بصوره⌯n \n تم تعطيل الامن بواسطه [❨'..Rutba(msg.sender_user_id_,msg.chat_id_)..'❩](T.ME/'..(data.username_ or 'p_120o')..')  ')
end,nil)   
end
if text == 'تفعيل الامن القصوه'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
bot_data:set(bot_id..'ghiktr'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'تم قفل الامن كامل\nتحظير هذا الحمايه تقفل كل حاجه بلتقييد\nتفعيل الحمايه دي بس عند التفليش او التحفيل\nلتعطيل الامن القصوه\nاكتب تعطيل الامن القصوه\n تم تفعيل الامن القصوه من قبل [『 '..Rutba(msg.sender_user_id_,msg.chat_id_)..' 』](T.ME/'..(data.username_ or 'p_120o')..')  ')
end,nil)   
end
if text == 'تعطيل الامن القصوه'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
bot_data:del(bot_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الامن القصوه من قبل [『 '..Rutba(msg.sender_user_id_,msg.chat_id_)..' 』](T.ME/'..(data.username_ or 'p_120o')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌝  مـن قبـل  ⇇ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'p_120o')..') \n 🌝 تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("مسح المطورين") and Devleg(msg) then
bot_data:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n 🌝 تم مسح قائمة المطورين  ")
end

if text == 'الملفات' and Devleg(msg) then
t = ' 🌝 ملفات السورس رودينا⇣\n ≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Devleg(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zoka00/zoka00/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🌝 اهلا بك في متجر ملفات رودينا\n 🌝 ملفات السورس ⇣\n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n\n"
local TextE = "\n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n 🌝 علامة تعني { ✔️ } ملف مفعل\n 🌝 علامة تعني { 【 ✗ 】  } ملف معطل\n 🌝 قناة سورس رودينا⇣\n".." 🌝 [اضغط هنا لدخول](t.me/p_120o) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and Devleg(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/zoka00/zoka00/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🌝 عذرا الملف لايدعم سورس رودينا\n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and Devleg(msg) then
...
if text == "مسح الملفات" and Devleg(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," 🌝 تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and Devleg(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
...
if text and text:match("^رفع مطور @(.*)$") and Devleg(msg) then
local username = text:match("^رفع مطور @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Devleg(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
bot_data:del(bot_id.."msa3d:leg")
bot_data:sadd(bot_id.."msa3d:leg", result.sender_user_id_)
bot_data:set(bot_id.."id:msa3d:leg", result.sender_user_id_)
...
bot_data:del(bot_id.."msa3d:leg")
bot_data:sadd(bot_id.."msa3d:leg", result.id_)
bot_data:set(bot_id.."id:msa3d:leg", result.id_)
...
bot_data:del(bot_id.."msa3d:leg")
bot_data:sadd(bot_id.."msa3d:leg", userid)
bot_data:set(bot_id.."id:msa3d:leg", userid)
Reply_Status(msg,userid,"reply"," 🌝 تم ترقيته انتيمي في البوت")  
return false 
end
if text == ("تنزيل الانتيمي") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(bot_id.."id:msa3d:leg")
Reply_Status(msg,id,"reply"," 🌝 تم تنزيله من الانتيمي")  
bot_data:del(bot_id.."msa3d:leg")
bot_data:del(bot_id.."id:msa3d:leg")
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
function Function_DRAGON(extra, result, success)
bot_data:sadd(bot_id.."Dev:leg:2", result.sender_user_id_)
...
bot_data:sadd(bot_id.."Dev:leg:2", result.id_)
...
bot_data:sadd(bot_id.."Dev:leg:2", userid)
...
function Function_DRAGON(extra, result, success)
bot_data:srem(bot_id.."Dev:leg:2", result.sender_user_id_)
...
function Function_DRAGON(extra, result, success)
if result.id_ then
bot_data:srem(bot_id.."Dev:leg:2", result.id_)
...
bot_data:srem(bot_id.."Dev:leg:2", userid)
...
bot_data:del(bot_id.."Dev:leg:2")
send(msg.chat_id_, msg.id_, "\n 🌝 تم مسح قائمة المطورين الثانوين  ")
end
if text == ("رفع ثانوي") and SudoBot(msg) then
function start_function(extra, result, success)
local keyboard = {
{{text ='مطور ثانوي عام',callback_data=msg.sender_user_id_.."Devleg"..result.sender_user_id_},{text ='مطور ثانوي مجموعه',callback_data=msg.sender_user_id_.."SirSudoGp"..result.sender_user_id_}},
{{text = '𝘾𝙃', url="t.me/p_120o"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == ("تنزيل ثانوي") and SudoBot(msg) then
function start_function(extra, result, success)
local keyboard = {
{{text ='مطور ثانوي عام',callback_data=msg.sender_user_id_.."Devleg"..result.sender_user_id_},{text ='مطور ثانوي مجموعه',callback_data=msg.sender_user_id_.."SirSudoGp"..result.sender_user_id_}},
{{text = '𝘾𝙃', url="t.me/p_120o"}},
...
if text == 'رفع' or text ==  'رفع رتبه' or text ==  'تنزيل' or text ==  'تنزيل رتبه' or text ==  'تحكم رتبه' and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local p_120o = bot_data:get(bot_id..'text:ch:user')
if p_120o then
send(msg.chat_id_, msg.id_,'['..p_120o..']')
...
bot_data:del(bot_id..'banda:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🌝 تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = bot_data:smembers(bot_id..'banda:MN:TF'..msg.chat_id_)
t = "\n 🌝 قائمة المنظفين \n≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
bot_data:sadd(bot_id..'banda:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'banda:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🌝 الـعـضو ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم ترقيته منظف'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'banda:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم ترقيته منظف'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'banda:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'banda:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🌝 الـعـضو ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم تنزيله من المنظفين'
texts = usertext..status
else
...
bot_data:srem(bot_id..'banda:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌝 لعضو  ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🌝 الـعـضو ⇇ '..userid..''
...
function start_function(extra, result, success)
bot_data:sadd(msg.sender_user_id_..'Sameer_Essam-zoaag1', result.sender_user_id_)
bot_data:sadd(result.sender_user_id_..'Sameer_Essam-zoaag2', msg.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌝 العضــو  ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
...
usertext = '\n 🌝  المستخدم  ⇇ ['..result.title_..'](t.me/'..(data.username_ or 'p_120o')..')'
status  = '\n 🌝 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
bot_data:del(bot_id..'searchinbot'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 🌝 تم تفعيل اليوتيوب') 
return false  
end
if text == 'تعطيل اليوتيوب' and Mod(msg) then  
bot_data:set(bot_id..'searchinbot'..msg.chat_id_,true) 
...
send(msg.chat_id_, msg.id_, t..'≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫\nاضغط علي الاسم ليتم نسخه\n[𝘾𝙃](t.me/p_120o)')
end
...
bot_data:set(bot_id.."KLAER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = bot_data:get(bot_id.."KLAER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🌝 ارسل التحذير عند ارسال الكلمه")  
bot_data:set(bot_id.."KLAER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
bot_data:set(bot_id.."KLAER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
bot_data:sadd(bot_id.."KLAER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = bot_data:get(bot_id.."KLAER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🌝 تم منع الكلمه مع التحذير")  
bot_data:del(bot_id.."KLAER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = bot_data:get(bot_id.."KLAER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
bot_data:set(bot_id.."KLAER1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
bot_data:del(bot_id.."KLAER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
if text == 'مسح كليشه المطور' and Devleg(msg) then
bot_data:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 🌝 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and Devleg(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🌝 الـعـضو ⇇ ['..result.title_..'](t.me/'..(text1[3] or 'p_120o')..')'..'\n 🌝 تم رفعه '..text1[2]..'')   
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not bot_data:get(bot_id..'banda:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
bot_data:setex(bot_id..'banda:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
bot_data:sadd(bot_id.."banda:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = bot_data:smembers(bot_id.."banda:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = " 🌝 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
bot_data:del(bot_id.."banda:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = bot_data:smembers(bot_id.."banda:allM"..msg.chat_id_)
...
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'رودينا').."" then  
Namebot = (bot_data:get(bot_id..'Name:Bot') or 'رودينا')
local DRAGON_Msg = {
'نعم يروحي🌝💙',
'نعم يا قلب  '..Namebot..'',
'عوز اي مني '..Namebot..'',
...
keyboard.inline_keyboard = {
{
{text = texxtt, url="t.me/"..dofile("./bakar.lua").botUserName},
},
{
{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./bakar.lua").botUserName.."?startgroup=start"},
},
...
if bot_data:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
...
if bot_data:get(bot_id..'Bc:Bots') and not Devleg(msg) then 
send(msg.chat_id_, msg.id_,' 🌝 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
...
--------------
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'رودينا').." غادر" or text == 'غادر' and Sudo(msg) then     
...
if text == 'تفعيل المغادره' and Devleg(msg) then   
...
if text == 'تعطيل المغادره' and Devleg(msg) then  
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني 😹💔🎶](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خالتك جرت ورايا 😹💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي 🥺💜](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام 🌝💛](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك 🌚❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي 🙈🌝](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر 🤤🌝](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب 😑😂](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي 😹👻](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب 😹💋💃🏻](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب 🙂❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي 🥺💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام 😹😹](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت  روحكك يبعيد 😹💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك 😎😂](t.me/p_120o)')
return false
end
if text == '😂' or text == '😂😂😂' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/p_120o)')
return false
end
if text == '😹' or text == '😹😹😹' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي 🤔](t.me/p_120o)')
return false
end
if text == '🌚' or text == '🌝' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك 🙂❤️](t.me/p_120o)')
return false
end
if text == '💋' or text == '💋💋💋' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/p_120o)')
return false
end
if text == '😭' or text == '😭😭😭' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب 😥](t.me/p_120o)')
return false
end
if text == '🥺' or text == '🥺🥺🥺' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك 😻🤍](t.me/p_120o)')
return false
end
if text == '😒' or text == '😒😒😒' then
local my_ph = bot_data:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒🙄](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 🤗🥰](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي 🌝❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي 👋💛](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي 🐣😹](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي 🌝❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف 🥺💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري 🌝❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص 😂😜](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام 🌝❤️](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال 😹](t.me/p_120o)')
return false
end 
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ 🙄💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[روح وعقل بوتك 🥺💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لا عيب بتكسف 😹💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[صح النوم 😹💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 😻🤍](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي 🌝💙](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى 🥺💔](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اي الثقافه دي 😒😹](t.me/p_120o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا 😒😹](t.me/p_120o)')
return false
end
...
send(msg.chat_id_, msg.id_,' 🌝 انت منشئ الجروب ياقميل ') 
return false
end
...
Text = ' 🌝 تم تفعيل أمر ضافني '
bot_data:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 🌝 بالتاكيد تم تفعيل أمر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' 🌝 تم تفعيل أمر اطردني مع سلامه'
bot_data:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 🌝 بالتاكيد تم تفعيل أمر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 🌝 تم تعطيل أمر اطردني يقميل'
else
Text = '\n 🌝 بالتاكيد تم تعطيل أمر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == "تنظيف المشتركين" and Devleg(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات" and Devleg(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
bot_data:set(bot_id.."ahmed:pr:p"..msg.chat_id_,"close")
end
if text == "تفعيل اطبع" and Manager(msg) then
send(msg.chat_id_, msg.id_,'تم تفعيل اطبع')
bot_data:set(bot_id.."ahmed:pr:p"..msg.chat_id_,"open")
end
if text and text:match("^اطبع (.*)$") and bot_data:get(bot_id.."ahmed:pr:p"..msg.chat_id_) == "open" then
...
if text == 'استعاده الاوامر' and Devleg(msg) then
...
if Text and Text:match("^(%d+)Devleg(.*)$") then
local notId  = Text:match("(%d+)")  
local userid = Text:gsub('Devleg',''):gsub(notId,'')
if tonumber(data.sender_user_id_) ~= tonumber(notId) then  
local notText ='✘ عذرا الاوامر هذه لا تخصك'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
...
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("تم رفعه مطور ثانوي عام")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))
return false
end
...
bot_data:sadd(bot_id.."SirSudoGp", userid)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘾𝙃', url="t.me/p_120o"}},
}
...
if not Mod(data) then
local notText = 'متلعبش ف زراير ي سكر '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
...
bot_data:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply"," 🌝 تم ترقيته مطور في بوت")  
return false 
end
...
bot_data:srem(bot_id..'msa3d:leg', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌝 الـعـضو ⇇ ['..data.first_name_..'](t.me/'..(data.username_ or 'p_120o')..')'
...
local Teext =[[
╗ سارسل اليك  سوال مع اختيارت لو حليت
╣ صح ستنجو من العقاب لو خطأ
╣ سيقوم عليك  العقاب
╣ السوال هوا - شيء لا يتأثر بالماء حتى عندما
╝ يمر من خلالها فمن يكون
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{{text = 'حروف بالصور', callback_data="/Xcvb"},{text = 'اصنع يوزر', callback_data="/klpou6"}}, 
...
{
{text = 'نبذه عن السورس', callback_data="/change-ghjjgyy"},{text = 'اسعار السرفرات', callback_data="/change-gfgko"},
},
{
{text = '𝘾𝙃', url="t.me/p_120o"},
},
...
local Teext =[[
┌ سعر السورس عند سمير
├ السورسات بتبدا مت 100 لي 200ج
└ سعر المصنع 100
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج سمير', url="t.me/Sameer_Essam"}},
{{text = 'بوت تواصل سمير',url="t.me/R_O_D_I_bot"}}, 
{{text = 'ᏴẨ₢Ḵ', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/change-gfgko' then
local Teext =[[
┌اسعار السرفر عند سمير
├سعر السرفر 2 رامه بي 50
├سعر السرفر 4 رامه بي 100
├سعر السرفر 8 رامه بي 150
└يوجود عروض سرفرات
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Teext =[[
≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫
╗ مرحبا بك في سورس رودينا الأفضل ♻️
╣ يعتبر سورس رودينا من احسن سورسات التلي ♻️
╣ السورس حمايه↤دقه↤عاليه↤أمان جدا ♻️
╣ السورس بيه كل مميزات اللي ممكن تحتاجه ♻️
╣ في بوتك الخاص بيك بوت حمايه الجروبات ♻️
╣ السورس خاص لي بوتات الحمايه من والسب ♻️
╣ السروس علي اامن مستواء علي الاطلاق ♻️
╣ يوجد اغاني وي افلام وي بحث يوتيوب ♻️
╣ يوجد ردود داخل السورس ردود جميل جدا ♻️
╝ لي مراقبة الجودة سورس انضم الي قنات السورس 
≪━━━━☩𝑹𝑶𝑫𝑰𝑵𝑨☩━━━━≫
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`تــواصــل الـسـورس´',url="t.me/R_O_D_I_bot"}}, 
{{text = '`قناة السـورس´', url="t.me/p_120o"}},
{{text = 'ᏴẨ₢Ḵ', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard.inline_keyboard = {
{{text = '𝘾𝙃',url="t.me/p_120o"}},
{{text = '`𝘾𝙃2´',url="t.me/UU_SD1"}},
{{text = 'ᏴẨ₢Ḵ', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/dadlegand' then
local Teext =[[
W𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 S𝐨𝐮𝐫𝐜𝐞 𝗥𝗼𝗱𝗹𝗻𝗮
]]
keyboard = {} 
...
{{text = '• ᴍʏ ᴅᴇᴠ', callback_data="/mydev"},{text = '• ᴍʏ ᴄʜᴀɴɴᴇʟ', callback_data="/channel"}},
{{text = 'مـطـوري♡', url="http://t.me/"..sudos.UserName}},
{{text = '• القائمه الرئيسيه •', callback_data="/XXX"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/dadlegand2' then
local Teext =[[
╭━─━─━─━─≪≫─━─━─━─━╮
🚨╎ 𝐖𝐞𝐥𝐜𝐨𝐦 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 Rodina.
ꔹ┉ ┉ ┉ ┉ ┉ ┉ꔹ┉ ┉ ┉ ┉ ┉ ┉ꔹ
🕹╎ 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐈𝐧 𝐓𝐞𝐥𝐞.
ꔹ┉ ┉ ┉ ┉ ┉ ┉ꔹ┉ ┉ ┉ ┉ ┉ ┉ꔹ
🔋╎ 𝐕𝐞𝐫𝐲 𝐏𝐫𝐨𝐭𝐞𝐜𝐭𝐞𝐝 𝐒𝐨𝐮 Rodina. 
╰━─━─━─━─≪≫─━─━─━─━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج سمير •',url="t.me/Sameer_Essam"}},
{{text = '• قناة السورس •',url="t.me/p_120o"}},
{{text = '• القائمه الرئيسيه •', callback_data="/XXX"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/XXX' then
local Teext =[[
• قائمـة الاشـكـال سـورس اخـتـار مـن الازرار •
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• شكل 1 •', callback_data="/dadlegand"},{text = '• شكل 2 •', callback_data="/dadlegand2"}},
...
الاعمال الملائمة : أطباء، صيادلة، مدررودينا، أخصائيو تغذية، شيف، سماسرة
...
if Text == '/asr4' then
Text = 'مرحبا اليك لو خيروك بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/JABWA4/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr11' then
Text = 'مرحبا اليك انيمي بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/taha_ow/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr12' then
Text = 'مرحبا اليك رامزيات ولاد بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/Boys_app/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr13' then
Text = 'مرحبا اليك رامزيات بنات بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/Girl_ap/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr14' then
Text = 'مرحبا اليك معلومه بالصور 🌝??'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/MALUEMA/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr15' then
Text = 'مرحبا اليك خلفيات رومانسيه بالصور 🌝??'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
{text = 'خلفيات أخري', callback_data="/asr15"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/jrumdi/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr16' then
Text = 'مرحبا اليك صور كرتون 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/ffadi8/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr17' then
Text = 'مرحبا اليك حروف بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
{text = 'حروف أخري', callback_data="/asr16"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/ffadi8/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/TIMO_JABWA/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/asr19' then
Text = 'مرحبا اليك انصحني بالصور 🌝💙'
ban = math.random(1,24); 
keyboard = {}
keyboard.inline_keyboard = {
{
{text = 'انصحني أخري', callback_data="/asr19"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/TIMO_JABWA2/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/ljljkj' then
Text = 'مرحبا اليك تويت بالصور 🌝💙'
ban = math.random(1,28); 
keyboard = {}
keyboard.inline_keyboard = {
{
...
local Name_Bot = (bot_data:get(bot_id..'Name:Bot') or 'رودينا')
if not bot_data:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' شنو رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'لوكي وزاحف من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير احب مال اني 🙂❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' }
...
numj = {"🙂🤸 الكلام ده صح 👍🙂","انت كداب يا ابو صلاح 😂😂","طب عيني في عينك كدا 🙄🧐","فعلا بتتكلم بجد ❤️🙂","👍😁 ده مظبوط","انت صح",};
